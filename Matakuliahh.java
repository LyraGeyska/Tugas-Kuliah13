...
public class Matakuliahh implements Serializable {
    ...
    public Matakuliahh(String kodemk) {
        this.kodemk = kodemk;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Matakuliahh)) {
            return false;
        }
        Matakuliahh other = (Matakuliahh) object;
    ...
    public String toString() {
        return "TugasDuaBelas.Matakuliah[ kodemk=" + kodemk + " ]";
    }
